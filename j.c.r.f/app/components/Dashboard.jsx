...
const Dashboard = ({ onLogout }) => {
  ...
  return (
    <div className="p-6 max-w-full mx-auto mt-16 flex flex-col min-h-screen">
      <div className="flex gap-4 md:gap-6 items-center mb-6">
        <button 
          className={`text-2xl md:text-3xl font-bold ${activeTab === 'dashboard' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
          onClick={() => setActiveTab('dashboard')}
        >
          Dashboard
        </button>
        <button 
          className={`text-2xl md:text-3xl font-bold ${activeTab === 'analytics' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
